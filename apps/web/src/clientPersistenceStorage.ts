...
export const CLIENT_SETTINGS_STORAGE_KEY = "oper8:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "oper8:saved-environment-registry:v1";
