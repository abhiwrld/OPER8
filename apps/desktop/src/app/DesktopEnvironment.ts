...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.t3Home, () => path.join(homeDirectory, ".oper8"));
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.abhiwrld.oper8.dev" : "com.abhiwrld.oper8",
    linuxDesktopEntryName: isDevelopment ? "oper8-dev.desktop" : "oper8.desktop",
    linuxWmClass: isDevelopment ? "oper8-dev" : "oper8",
    userDataDirName,
