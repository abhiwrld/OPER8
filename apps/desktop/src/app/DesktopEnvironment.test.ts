...
const defaultInput = {
  ...
  processArch: "arm64",
  appVersion: "0.0.22",
  appPath: "/Applications/OPER8.app/Contents/Resources/app.asar",
  isPackaged: false,
  resourcesPath: "/Applications/OPER8.app/Contents/Resources",
...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.abhiwrld.oper8.dev");
      assert.equal(environment.linuxWmClass, "oper8-dev");
      assert.deepEqual(
