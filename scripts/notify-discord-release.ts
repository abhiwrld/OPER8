  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new OPER8 prerelease is available for nightly testers."
          : "A new OPER8 latest release is available.",
...
).pipe(Command.withDescription("Post a OPER8 release announcement to Discord."));
